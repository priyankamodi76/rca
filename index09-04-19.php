            ...
            <div class="row g-margin-b-60--xs g-margin-b-70--md">
                <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md" >
                    <div class="clearfix">
						...
						<a href="courses.php">
						 <p class="g-margin-b-0--xs">I Want to Join</p>
                            <h3 class="g-font-size-18--xs">Reckon Courses</h3>
                           </a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md" >
                    <div class="clearfix">
						...
						<a href="https://www.youtube.com/playlist?list=PLJyvawuT3T-T8TKNxwl5lx0Q6i5NdGbgq" target="_blank">
						 <p class="g-margin-b-0--xs">I Want to Know About </p>
                            <h3 class="g-font-size-18--xs">New Job Openings</h3>
                           </a>
                        </div>
                    </div>
                </div>
               <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md" >
                    <div class="clearfix">
						...
						<a href="https://www.youtube.com/playlist?list=PLJyvawuT3T-SU0qRQOdgc58qcPfvKxm1z" target="_blank">
						 <p class="g-margin-b-0--xs">Show me</p>
                            <h3 class="g-font-size-18--xs">Demo Videos</h3>
               ...
               <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md" >
                    <div class="clearfix">
                        ...
                        <div class="g-media__body g-padding-x-20--xs">
						  ...
						  <p class="g-margin-b-0--xs">I want to Check</p> 
                            <h3 class="g-font-size-18--xs">Reckon Results</h3>
                ...
                <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md" >
                    <div class="clearfix">
                        ...
                        <div class="g-media__body g-padding-x-20--xs">
						<a href="gate.php" >
						 <p class="g-margin-b-0--xs"><b>I Want to Know various </b></p>
              ...
              <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md" >
                    <div class="clearfix">
						...
						<a href="javascript:void(0)" data-fid="0x3a293d20b7050417:0xa75644c909b9bb0e" data-is_owner="false" data-reply_source="merchant-replies-lu" data-sort_by="qualityScore" data-async-trigger="reviewDialog" jsaction="r.BMsjWllwe1s" data-rtid="inN2IWeEjHcM" jsl="$x 2;" data-ved="2ahUKEwjXvuzUyYvhAhWS2KQKHUAeAcEQ8mswEXoECAYQIQ">
						 <p class="g-margin-b-0--xs"><b>I want to see Reckon's </b></p>
