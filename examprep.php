  ...
  <!-- Features -->
        <div id="js__scroll-to-section" class="container g-padding-y-80--xs g-padding-y-125--sm" >
            <div class="g-text-center--xs g-margin-b-40--xs">
                <h1 class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-25--xs">Which exam do you want to explore today</h1>
            ...
            <div class="row g-margin-b-60--xs g-margin-b-0--md">
                    ...
                    <div class="clearfix">
						...
						<a href="gate_new.php">
						 <p class="g-margin-b-0--xs" style="color:#656565;"><b>I Want to know about</b></p>
                            <h3 class="g-font-size-18--xs"><b>GATE</b></h3>
                           </a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md" >
                    <div class="clearfix">
						...
						<a href="ese_new.php">
						 <p class="g-margin-b-0--xs" style="color:#656565;" ><b>I Want to Know About</b> </p>
                            <h3 class="g-font-size-18--xs"><b>ESE</b></h3>
                           </a>
                        </div>
                    </div>
                </div>
               <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md" >
                    <div class="clearfix">
						...
						<a href="ssc.php" >
						 <p class="g-margin-b-0--xs" style="color:#656565;"><b>I want to know about</b></p>
                            <h3 class="g-font-size-18--xs"><b>SSC JE</b></h3>
